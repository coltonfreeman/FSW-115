...
let shots = document.createElement("h3");
shots.textContent = `Here is a list of cocktails that start with "A" `;
document.body.appendChild(shots);
let ulist = document.createElement("ul");
for (drinks of cockTails.drinks) {
